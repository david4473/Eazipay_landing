<template lang="">
  <div class="px-14">
    <nav class="flex items-center">
      <div class="mr-auto flex justify-between items-center w-[60%]">
        <div>
          <svg
            width="122"
            height="32"
        ...
        <ul class="flex gap-8">
          ...
          <li><a href="#">Set your payroll</a></li>
        </ul>
      </div>
      <div>
        <button
          class="header__button border border-[--primary] text-[primary] mr-6"
        >
          Log in
        </button>
        <button class="header__button bg-[--primary] text-white shadow-lg">
          Register
        </button>
      </div>
    </nav>
